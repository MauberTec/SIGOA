            ...
            if (!IsPostBack)
            {
                ...
                if (relatorio.StartsWith("rptRelatorio"))
                {
                    ...
                    switch (relatorio)
                    {
                        ...
                        case "rptRelatorio_AnomaliasAgRep":
                            ds = new RelatoriosDAO().AnomaliasAgRep_Ds(Request["FiltroRodovias"],
                                                                    Request["FiltroRegionais"],
                                                                    Request["FiltroObj_codigo"],
                                                                    strRegionais,
                                                                    gUsuario.usu_id);
                            ...
                            ReportViewer1.LocalReport.DataSources.Clear();
                            rds1 = new ReportDataSource("dtAnomalias", ds.Tables[0]);
                            ReportViewer1.LocalReport.DataSources.Add(rds1);
                            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rptRelatorio_AnomaliasAgRep.rdlc");
                            break;


                        case "rptRelatorio_OSRecup":
                            ds = new RelatoriosDAO().OSRecup_Ds(Request["FiltroRodovias"],
                                                                    Request["FiltroRegionais"],
                                                                    Request["FiltroObj_codigo"],
                                                                    strRegionais,
                                                                    gUsuario.usu_id);
                            ...
                            ReportViewer1.LocalReport.DataSources.Clear();
                            rds1 = new ReportDataSource("dtOSRecup", ds.Tables[0]);
                            ReportViewer1.LocalReport.DataSources.Add(rds1);
                            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rptRelatorio_OSRecup.rdlc");
                            break;



                        case "rptRelatorio_OrcamentosApr":
                            ds = new RelatoriosDAO().OrcamentosApr_Ds(Request["FiltroRodovias"],
                                                                    Request["FiltroRegionais"],
                                                                    Request["FiltroObj_codigo"],
                                                                    strRegionais,
                                                                    gUsuario.usu_id);
                            ...
                            ReportViewer1.LocalReport.DataSources.Clear();
                            rds1 = new ReportDataSource("dtOrcamentosApr2", ds.Tables[0]);
                            ReportViewer1.LocalReport.DataSources.Add(rds1);
                            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Reports/rptRelatorio_OrcamentosApr.rdlc");
                            break;
