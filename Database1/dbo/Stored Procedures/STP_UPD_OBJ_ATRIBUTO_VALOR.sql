CREATE procedure [dbo].[STP_UPD_OBJ_ATRIBUTO_VALOR] 
@obj_id int,
@atr_id int,
@ati_id int = null,
...
if ( @tem = 0 )
begin
	exec dbo.STP_INS_OBJ_ATRIBUTO_VALORES 
											@obj_id,
											@atr_id,
											@ati_id,
											@atv_valor,
...
set nocount on;
				...
				SELECT 1 as nRow, atv_id, obj_id, atr_id, ati_id, atv_valor, uni_id, atv_ativo, atv_deletado, atv_data_criacao, atv_criado_por, atv_data_atualizacao, atv_atualizado_por
				into #tmpComparar 
				from dbo.tab_objeto_atributos_valores
				where atv_deletado is null
					and obj_id = @obj_id
...
set nocount on;
				...
				SELECT 2 as nRow, atv_id, obj_id, atr_id, ati_id, atv_valor, uni_id, atv_ativo, atv_deletado, atv_data_criacao, atv_criado_por, atv_data_atualizacao, atv_atualizado_por
				from dbo.tab_objeto_atributos_valores
				where atv_deletado is null
					and obj_id = @obj_id
					and atr_id = @atr_id;
