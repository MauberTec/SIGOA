create procedure [dbo].[STP_UPD_ATIVARDESATIVAR_DOCUMENTO] 
@doc_id int,
@usu_id int,
@ip nvarchar(30)
--with encryption
...
begin try
		BEGIN TRAN T1
					...
					set doc_ativo = ~ doc_ativo,
						doc_data_atualizacao = GETDATE(),
			...
			-- ********* INSERÇÃO DE LOG **************************************
				...
				declare @doc_ativo int = 0; 

				set @doc_ativo = (select doc_ativo 
