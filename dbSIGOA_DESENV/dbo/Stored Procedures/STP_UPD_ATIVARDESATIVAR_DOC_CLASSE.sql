CREATE procedure [dbo].[STP_UPD_ATIVARDESATIVAR_DOC_CLASSE] 
@dcl_id int,
@usu_id int,
@ip nvarchar(30)
...
begin try
		BEGIN TRAN T1
					...
					set dcl_ativo = ~ dcl_ativo,
						dcl_data_atualizacao = GETDATE(),
			...
			-- ********* INSERÇÃO DE LOG **************************************
				...
				declare @dcl_ativo int = 0; 

				set @dcl_ativo = (select dcl_ativo 
