CREATE TABLE [dbo].[tab_inspecoes] (
    ...
    CONSTRAINT [FK_tab_notificacao_ocorrencias_tab_ordens_servico] FOREIGN KEY ([ord_id]) REFERENCES [dbo].[tab_ordens_servico] ([ord_id]),
    CONSTRAINT [FK_tab_notificao_ocorrencias_tab_ordens_servico] FOREIGN KEY ([ord_id]) REFERENCES [dbo].[tab_ordens_servico] ([ord_id])
);
